...
if(interactive()){
  args <- scan(text=
                 "MazinLeafcutterAnalysis/leafcutter/clustering/leafcutter_perind_numers.counts.gz MazinLeafcutterAnalysis/leafcutter/juncTableBeds/PSI_ByMax.bed MazinLeafcutterAnalysis/leafcutter/juncTableBeds/PSI.bed MazinLeafcutterAnalysis/leafcutter/juncTableBeds/JuncCounts.bed", what='character')
} else{
